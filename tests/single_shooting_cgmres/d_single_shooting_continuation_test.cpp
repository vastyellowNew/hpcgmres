...
TEST_F(d_single_shooting_continuation_test, dim) {
  EXPECT_EQ(dimx, d_single_shooting_continuation_dimx());
  EXPECT_EQ(dimu, d_single_shooting_continuation_dimu());
  EXPECT_EQ(dimc, d_single_shooting_continuation_dimc());
}
